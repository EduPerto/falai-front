      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {agent && (
          <div className="p-4 border-b border-neutral-700 bg-neutral-900 flex items-center justify-between">
                ...
                <div>
                  <h1 className="text-lg font-medium text-white flex items-center gap-2">
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-6 w-6 text-neutral-400 hover:text-blue-400 p-0.5"
            ...
            <Badge className="bg-blue-500 text-white px-3 py-1 text-sm border-0">
              Shared Agent
            </Badge>
          </div>
        )}
        ...
        {(selectedSession || agentParams) ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-6 bg-neutral-950">
            ...
            <Button
              ...
              className="bg-blue-500 text-white hover:bg-blue-600 px-6 py-6 h-auto rounded-xl"
            >
              Connect to Agent
            </Button>
          </div>
