...
if __name__ == "__main__":
  ...
  return (
    <Card className="bg-[#1a1a1a] border-[#333] text-white">
      <CardHeader>
        <CardTitle className="text-blue-400">Code Examples</CardTitle>
      ...
      <CardContent>
        <Tabs defaultValue="curl">
          <TabsList className="bg-[#222] border-[#333] mb-4">
            <TabsTrigger value="curl" className="data-[state=active]:bg-[#333] data-[state=active]:text-blue-400">
              cURL
            </TabsTrigger>
            <TabsTrigger value="javascript" className="data-[state=active]:bg-[#333] data-[state=active]:text-blue-400">
              JavaScript
            </TabsTrigger>
            <TabsTrigger value="python" className="data-[state=active]:bg-[#333] data-[state=active]:text-blue-400">
              Python
            </TabsTrigger>
          </TabsList>
...
if __name__ == '__main__':
    asyncio.run(send_message_with_files())`}
            ...
            <div>
              <h4 className="text-lg font-medium text-blue-400 mb-2">JavaScript/TypeScript</h4>
              <CodeBlock
...
async function sendMessageWithFiles() {
  ...
  console.log('Agent response:', data);
            ...
            <div>
              <h4 className="text-lg font-medium text-blue-400 mb-2">Curl</h4>
              <CodeBlock
