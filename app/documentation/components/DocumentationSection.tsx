...
export function DocumentationSection({ copyToClipboard }: DocumentationSectionProps) {
  ...
  return (
    <div className="space-y-8">
      {/* Hero Section */}
      <Card className="bg-gradient-to-br from-blue-500/10 to-blue-500/10 border-blue-500/20 text-white">
        <CardHeader className="text-center">
          <div className="flex justify-center mb-4">
            <div className="flex items-center space-x-2 bg-blue-500/20 px-4 py-2 rounded-full">
              <Network className="h-6 w-6 text-blue-400" />
              <span className="font-bold text-blue-400">Agent2Agent Protocol</span>
            </div>
          </div>
          <CardTitle className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-blue-400 bg-clip-text text-transparent">
        ...
        <CardContent>
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            ...
            >
              ...
              <span className="text-blue-400">Official Specification</span>
      ...
      <Card className="bg-[#1a1a1a] border-[#333] text-white">
        <CardHeader>
          <CardTitle className="text-blue-400">Protocol Methods</CardTitle>
        ...
        <CardContent>
          <Tabs defaultValue="messaging" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-[#222] border-[#444]">
              <TabsTrigger value="messaging" className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400">
                Messaging
              </TabsTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#222] p-4 rounded-lg border border-[#444]">
                  <div className="flex items-center space-x-2 mb-3">
                    <Badge variant="outline" className="border-blue-500 text-blue-400">message/send</Badge>
      ...
      <Card className="bg-[#1a1a1a] border-[#333] text-white">
        <CardHeader>
          <CardTitle className="text-blue-400">Quick Start Examples</CardTitle>
        ...
        <CardContent>
          <Tabs defaultValue="basic" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-[#222] border-[#444]">
              ...
              <TabsTrigger value="streaming" className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400">
                Streaming
              </TabsTrigger>
              <TabsTrigger value="files" className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400">
                File Upload
              </TabsTrigger>
            </TabsList>
              ...
              <div className="space-y-3">
                <div className="bg-[#222] p-3 rounded-lg border border-[#444]">
                  <div className="flex items-center space-x-2 mb-2">
                    <code className="text-blue-400 text-sm">x-api-key</code>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-[#222] border-b border-[#444]">
                  ...
                  <th className="p-4 text-left text-blue-400">Agent2Agent (A2A)</th>
              ...
              <tbody>
                ...
                <tr className="border-b border-[#333]">
                  ...
                  <td className="p-4 text-neutral-300 text-blue-400">✓ Can use MCP internally</td>
