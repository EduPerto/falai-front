    ...
    <div className="space-y-4">
      ...
      <div className="p-4 bg-[#1a1a1a] border border-[#333] rounded-md">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-medium text-blue-400">A2A Streaming Mode</span>
        ...
        {currentTaskId && (
          <div className="mt-2 pt-2 border-t border-[#333]">
            ...
            <span className="text-xs text-blue-400 font-mono">{currentTaskId}</span>
          </div>
        )}
      </div>
      ...
      <Button
        ...
        disabled={isStreaming}
        className="bg-blue-400 text-black hover:bg-[#00cc7d] w-full mt-4"
      >
        {isStreaming ? (
