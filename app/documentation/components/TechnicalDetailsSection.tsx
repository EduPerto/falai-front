...
export function TechnicalDetailsSection({ copyToClipboard }: TechnicalDetailsSectionProps) {
  return (
    <Card className="bg-[#1a1a1a] border-[#333] text-white">
      <CardHeader>
        <CardTitle className="text-blue-400">Technical Details of the Methods</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        <div>
          <h3 className="text-blue-400 text-lg font-medium mb-2">Method message/send</h3>
...
x-api-key: YOUR_API_KEY`)}
        ...
        <div>
          <h3 className="text-blue-400 text-lg font-medium mb-2">Method message/stream</h3>
          <p className="text-neutral-300 mb-4">
...
`)}
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-neutral-300 space-y-2 mb-4">
                <li><span className="text-blue-400">Status Updates</span>: Contains the <code className="bg-[#333] px-1 rounded">status</code> field with information about the task status.</li>
                <li><span className="text-blue-400">Artifact Updates</span>: Contains the <code className="bg-[#333] px-1 rounded">artifact</code> field with the content generated by the agent.</li>
                <li><span className="text-blue-400">Ping Events</span>: Simple events with the format <code className="bg-[#333] px-1 rounded">: ping</code> to keep the connection active.</li>
              </ul>
            </div>
  ...
  eventSource.close();
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-neutral-300 space-y-1">
                <li><span className="text-blue-400">submitted</span>: Task sent but not yet processed</li>
                <li><span className="text-blue-400">working</span>: Task being processed by the agent</li>
                <li><span className="text-blue-400">completed</span>: Task completed successfully</li>
                <li><span className="text-blue-400">input-required</span>: Agent waiting for additional user input</li>
                <li><span className="text-blue-400">failed</span>: Task failed during processing</li>
                <li><span className="text-blue-400">canceled</span>: Task was canceled</li>
              </ul>
            </div>
          </div>
        </div>
