...
export function FrontendImplementationSection({ copyToClipboard }: FrontendImplementationSectionProps) {
  return (
    <Card className="bg-[#1a1a1a] border-[#333] text-white">
      <CardHeader>
        <CardTitle className="text-blue-400">Frontend implementation</CardTitle>
      ...
      <CardContent className="space-y-6">
        <Tabs defaultValue="standard">
          <TabsList className="bg-[#222] border-[#333] mb-4">
            <TabsTrigger value="standard" className="data-[state=active]:bg-[#333] data-[state=active]:text-blue-400">
              Standard HTTP
            </TabsTrigger>
            <TabsTrigger value="streaming" className="data-[state=active]:bg-[#333] data-[state=active]:text-blue-400">
              Streaming SSE
            </TabsTrigger>
            <TabsTrigger value="react-component" className="data-[state=active]:bg-[#333] data-[state=active]:text-blue-400">
              React component
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="standard">
            <div>
              <h3 className="text-blue-400 text-lg font-medium mb-2">Implementation of message/send</h3>
  ...
  try {
    ...
    setIsLoading(false);
          ...
          <TabsContent value="streaming">
            <div>
              <h3 className="text-blue-400 text-lg font-medium mb-2">Implementation of message/stream (Streaming)</h3>
              <p className="text-neutral-300 mb-4">
  ...
  try {
    ...
    return null;
          ...
          <TabsContent value="react-component">
            <div className="mt-4">
              <h4 className="font-medium text-blue-400 mb-2">React component with streaming support:</h4>
              <div className="relative">
                <CodeBlock
