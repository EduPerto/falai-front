        ...
        <div className="col-span-3 space-y-4">
          <div className="flex items-center">
                  ...
                  apiKeys
                    ...
                    .map((key) => (
                      <SelectItem
                        key={key.id}
                        value={key.id}
                        className="data-[selected]:bg-[#333] data-[highlighted]:bg-[#333] !text-white focus:!text-white hover:text-blue-400 data-[selected]:!text-blue-400"
                      >
                        <div className="flex items-center">
                          <span>{key.name}</span>
                          <Badge className="ml-2 bg-[#333] text-blue-400 text-xs">
                            {key.provider}
                          </Badge>
                        </div>
                      </SelectItem>
            ...
            <Button
              ...
              className="ml-2 bg-[#222] text-blue-400 hover:bg-[#333]"
            >
        ...
        <div className="col-span-3">
          ...
          <div className="mt-1 text-xs text-neutral-400">
            ...
            <span>
              ...
              <span className="ml-2 text-blue-400">Click to expand editor.</span>
            </span>
          </div>
        </div>
      </div>
