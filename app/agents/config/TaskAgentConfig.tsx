          ...
          {values.config?.tasks && values.config.tasks.length > 0 ? (
            <div className="space-y-4 mb-4">
              {values.config.tasks.map((task, index) => (
                <div
                  key={index}
                  className={`border border-[#333] rounded-md p-3 ${editingTaskIndex === index ? "bg-[#1e3a3a]" : "bg-[#2a2a2a]"
                    }`}
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                      ...
                      {task.expected_output && (
                        <div className="mt-2">
                          ...
                          <Badge
                            variant="outline"
                            className="ml-2 bg-[#333] text-blue-400 border-blue-400/30"
                          >
                            {task.expected_output}
                          </Badge>
                        </div>
                        ...
                        <div className="mt-2">
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            {task.enabled_tools.map((toolId) => (
                              <Badge
                                key={toolId}
                                className="bg-[#333] text-blue-400 border border-blue-400/30 text-xs"
                              >
                                {toolId}
                              </Badge>
                            ))}
                    ...
                    <div className="flex">
                      <Button
                        ...
                        className="text-neutral-400 hover:text-blue-400 hover:bg-[#333] mr-1"
                      >
              ...
              <div className="space-y-3 border-t border-[#333] pt-4">
                <h4 className="text-sm font-medium text-white flex items-center justify-between">
                  ...
                  {isEditing && (
                    <Button
                      ...
                      className="text-neutral-400 hover:text-blue-400 hover:bg-[#333]"
                    >
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <button
                        type="button"
                        className="absolute top-3 right-5 text-neutral-400 hover:text-blue-400 focus:outline-none"
                        onClick={handleExpandDescription}
                      >
                  ...
                  <div className="mt-3">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {newTask.enabled_tools.map((toolId) => (
                        <Badge
                          key={toolId}
                          className="bg-[#333] text-blue-400 border border-blue-400/30"
                        >
                          {toolId}
                        </Badge>
                      ))}
                ...
                <div className="flex items-center justify-between mt-3">
                  <Button
                    ...
                    className="border-blue-400 text-blue-400 hover:bg-blue-400/10 px-3"
                  >
                  ...
                  <Button
                    ...
                    className="bg-[#222] text-blue-400 border border-blue-400 hover:bg-blue-400/10"
                  >
        ...
        <DialogContent className="sm:max-w-[1200px] max-h-[90vh] bg-[#1a1a1a] border-[#333] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-hidden flex flex-col min-h-[60vh]">
            <Textarea
              ...
              className="flex-1 min-h-full bg-[#222] border-[#444] text-white p-4 focus:border-blue-400 focus:ring-blue-400 focus:ring-opacity-50 resize-none"
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className="bg-blue-400 text-black hover:bg-[#00cc7d]"
            >
              ...
              filteredTools.map((tool) => (
                ...
                >
                  <Checkbox
                    ...
                    className="border-[#444] data-[state=checked]:bg-blue-400 data-[state=checked]:text-black"
                  />
                  <Label
                    htmlFor={tool.id}
                  ...
                  <Badge className="bg-[#333] text-blue-400">{tool.id}</Badge>
                </div>
              ))
            ) : (
