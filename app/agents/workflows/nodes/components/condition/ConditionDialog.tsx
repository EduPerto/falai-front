          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-1 gap-2">
              {conditionTypes.map((type) => (
                <div
                  key={type.id}
                  className={`flex items-center space-x-3 rounded-md border p-3 cursor-pointer transition-all ${selectedType === type.id
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-md bg-neutral-700/50 border border-neutral-600 p-3 mt-4">
                  ...
                  <div className="text-sm">
                    ...
                    {" "}
                    {!["is_defined", "is_not_defined"].includes(selectedOperator) && (
                      <span className="text-blue-400 font-medium">"{comparisonValue || "(empty)"}"</span>
                    )}
                  </div>
                </div>
              </div>
