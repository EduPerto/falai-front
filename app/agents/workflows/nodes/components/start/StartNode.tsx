...
export function StartNode(props: NodeProps) {
  ...
  return (
    <BaseNode hasTarget={true} selected={selected || false} borderColor="start" isExecuting={isExecuting}>
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-lg font-medium text-blue-400">Start</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-2 flex items-center justify-end text-sm text-neutral-400 transition-colors">
        ...
        <Handle
          className={cn(
            ...
            isSourceHandleConnected ? "!bg-blue-500 !border-blue-400" : "!bg-neutral-400 !border-neutral-500",
            selected && isSourceHandleConnected && "!bg-blue-400 !border-blue-300"
          )}
          style={{
            right: "-8px",
            top: "calc(100% - 25px)",
