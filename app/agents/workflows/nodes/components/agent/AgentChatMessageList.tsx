                        ...
                        >
                            ...
                            <div
                                className={`rounded-lg p-3 ${isFunctionMessage || isTaskExecutor
                                    ? "bg-[#333] text-blue-400 font-mono text-sm"
                                    : isUser
                            ...
                            >
                                {isWorkflowNode && (
                                    <div className="text-xs text-blue-500 mb-1 flex items-center space-x-1 bg-blue-950/30 p-1 rounded">
                                        ...
                                        {((typeof messageContent === "string" &&
                                            ...
                                            <ReactMarkdown
                                                ...
                                                components={{
                                                    ...
                                                    a: ({ ...props }) => (
                                                        <a
                                                            className="text-blue-400 underline hover:opacity-80 transition-opacity"
                                                            target="_blank"
                                                    ...
                                                    code: ({ className, children, ...props }: any) => {
                                                        ...
                                                        if (isInline) {
                                                            return (
                                                                <code
                                                                    className="bg-[#333] px-1.5 py-0.5 rounded text-blue-400 text-sm font-mono"
                                                                    {...props}
                                                                >
                                                                    {children}
                                                                </code>
