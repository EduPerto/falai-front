                    ...
                    <div className="flex items-start justify-between">
                        <div className="flex-1">
                            <div className="flex items-center mb-1">
                                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-600 to-blue-900 flex items-center justify-center shadow-lg mr-3">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <Badge
                                            className="bg-blue-900/40 text-blue-400 border border-blue-700/50 px-2"
                                        >
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            >
                                <RefreshCw size={18} className={isInitializing ? "animate-spin text-blue-400" : ""} />
                ...
                <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 bg-gradient-to-b from-neutral-900/50 to-neutral-950" ref={messagesContainerRef}>
                    {isInitializing ? (
                        <div className="flex flex-col items-center justify-center h-full">
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shadow-lg mb-4 animate-pulse">
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center px-6">
                            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500/20 to-blue-500/20 flex items-center justify-center shadow-lg mb-5 border border-blue-500/30">
                        ...
                        <div className="space-y-4 w-full max-w-full">
                            {messages.map((message) => {
                                ...
                                const agentColor = message.author === "user" ? "bg-blue-500" : "bg-gradient-to-br from-neutral-800 to-neutral-900";
