                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="col-span-3 flex items-center">
                      <Checkbox
                        ...
                        className="mr-2 data-[state=checked]:bg-blue-400 data-[state=checked]:border-blue-400"
                      />
              ...
              {isLoading ? (
                ...
                <div className="space-y-2">
                  {apiKeys.map((apiKey) => (
                    <div
                      key={apiKey.id}
                      className="flex items-center justify-between p-3 bg-[#222] rounded-md border border-[#333] hover:border-blue-400/30"
                    >
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge
                            variant="outline"
                            className="bg-[#333] text-blue-400 border-blue-400/30"
                          >
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          className="text-neutral-300 hover:text-blue-400 hover:bg-[#333]"
                        >
                ...
                <div className="text-center py-10 border border-dashed border-[#333] rounded-md bg-[#222] text-neutral-400">
                  ...
                  <Button
                    onClick={handleAddClick}
                    className="mt-4 bg-[#333] text-blue-400 hover:bg-[#444]"
                  >
                    <Plus className="mr-2 h-4 w-4" />
                    Add Key
                  </Button>
