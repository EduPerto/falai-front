  ...
  const FieldList = <T extends Record<string, any>>({
    ...
    <div className="border border-neutral-700 rounded-md p-3 bg-neutral-800/50">
      ...
      <Button
        ...
        size="sm"
        onClick={onAdd}
        className="w-full border-blue-500/30 text-blue-400 hover:bg-blue-500/10 bg-neutral-800/30"
      >
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex items-start justify-between p-6 border-b border-neutral-800">
            ...
            <div className="flex items-center gap-3">
              <Badge variant="outline" className="bg-neutral-800 text-blue-400 border-blue-500/30 uppercase text-xs font-semibold px-2 py-0.5">
                {tool.method || "GET"}
              </Badge>
            </div>
          </div>
          ...
          <div className="flex-1 flex overflow-hidden">
                    ...
                    >
                      ...
                      {(
                        ...
                        (item.id === 'defaults' && valuesList.length > 0)
                          ...
                          <span className="ml-auto bg-blue-500/20 text-blue-400 text-xs rounded-full px-1.5 py-0.5 min-w-[18px]">
            ...
            <div className="flex-1 overflow-auto">
              ...
              {activeTab === 'endpoint' && (
                <div className="p-6">
                  <div className="space-y-6">
                    ...
                    <div className="p-4 bg-neutral-800/80 border border-blue-600/20 rounded-md mt-6">
                      <h3 className="text-blue-400 text-sm font-medium mb-2 flex items-center">
                        <Info className="h-4 w-4 mr-2" /> How to use variables in your endpoint
                      </h3>
                      <p className="text-neutral-300 text-sm mb-3">
                        You can use dynamic variables in your endpoint using the <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-blue-300">{"{VARIABLE_NAME}"}</code> syntax.
                      </p>
                      <div className="grid grid-cols-1 gap-4 text-xs">
                        <div>
                          ...
                          <code className="block bg-neutral-900 text-neutral-200 p-2 rounded">
                            https://api.example.com/users/<span className="text-blue-400">{"{userId}"}</span>/profile
                          </code>
                          <p className="mt-1 text-neutral-400">Define <code className="bg-neutral-700 px-1 py-0.5 rounded text-blue-300">userId</code> as a Path Parameter</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === 'body' && (
                <div className="p-6">
                  <div className="mb-6 p-4 bg-neutral-800/80 border border-blue-600/20 rounded-md">
                    <h3 className="text-blue-400 text-sm font-medium mb-2 flex items-center">
                    ...
                    <p className="text-neutral-300 text-sm">
                      ...
                      You can use variables like <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-blue-300">{"{variableName}"}</code> that will be replaced at runtime.
                    </p>
                  </div>
                ...
                <div className="p-6">
                  <div className="mb-6 p-4 bg-neutral-800/80 border border-blue-600/20 rounded-md">
                    ...
                    <p className="text-neutral-300 text-sm">
                      ...
                      For example, in <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-blue-300">https://api.example.com/users/{"{userId}"}</code>,
                      <code className="bg-neutral-700 px-1 py-0.5 rounded text-blue-300">userId</code> is a path parameter.
                    </p>
                  </div>
                ...
                <div className="p-6">
                  <div className="mb-6 p-4 bg-neutral-800/80 border border-blue-600/20 rounded-md">
                    ...
                    <p className="text-neutral-300 text-sm">
                      ...
                      For example: <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-blue-300">https://api.example.com/search?query=term&limit=10</code>
                    </p>
                  </div>
          ...
          <div className="border-t border-neutral-800 p-4 flex items-center justify-between">
            ...
            <Button
              onClick={handleSave}
              className="bg-blue-500 text-neutral-950 hover:bg-blue-400"
