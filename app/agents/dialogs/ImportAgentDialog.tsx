    ...
    >
      <DialogContent className="sm:max-w-[500px] bg-[#1a1a1a] border-[#333] text-white">
        ...
        <div className="flex flex-col space-y-4 py-4">
          <div
            className={`h-40 border-2 border-dashed rounded-md flex flex-col items-center justify-center p-4 transition-colors cursor-pointer ${dragActive
                ? "border-blue-400 bg-blue-900/20"
                : file
                  ? "border-blue-600 bg-blue-900/10"
                  : "border-[#444] hover:border-blue-600/50"
              }`}
          ...
          >
            {file ? (
              <div className="flex flex-col items-center space-y-2">
                <FileJson className="h-10 w-10 text-blue-400" />
