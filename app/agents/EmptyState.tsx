...
export function EmptyState({
  ...
  const getIcon = () => {
    switch (type) {
      case "empty-folder":
        return <Folder className="h-16 w-16 text-blue-400" />;
      case "search-no-results":
        return <Search className="h-16 w-16 text-blue-400" />;
      case "no-agents":
      default:
        return <Server className="h-16 w-16 text-blue-400" />;
    }
  };
        ...
        <Button
          ...
          className={
            type === "search-no-results"
              ...
              : "bg-blue-400 text-black hover:bg-[#00cc7d] px-6 py-2 hover:shadow-[0_0_15px_rgba(0,255,157,0.2)]"
          }
        >
