    ...
    <div className={`relative flex items-center gap-2 ${className}`}>
      <div className="relative flex-1">
        ...
        <Input
          ...
          autoComplete="off"
          className="pl-10 w-full bg-[#222] border-[#444] text-white focus:border-blue-400 focus:ring-blue-400/10"
        />
        {value && (
          <button
      ...
      {agentTypes.length > 0 && onAgentTypeChange && (
        <Popover open={isFilterOpen} onOpenChange={setIsFilterOpen}>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className={`px-3 py-2 bg-[#222] border-[#444] hover:bg-[#333] ${selectedAgentType ? "text-blue-400" : "text-neutral-400"
                }`}
            >
