        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative flex items-center">
            <input
              id="agent-card-url"
              type="text"
              className="w-full bg-[#2a2a2a] border border-[#444] rounded-md px-3 py-2 text-white pr-12 focus:outline-none focus:ring-2 focus:ring-blue-400/40"
              value={
            ...
            <button
              type="button"
              className="absolute right-2 text-neutral-400 hover:text-blue-400 px-1 py-1"
              onClick={async () => {
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative flex items-center">
            <input
              ...
              className="w-full bg-[#2a2a2a] border border-[#444] rounded-md px-3 py-2 text-white pr-24 focus:outline-none focus:ring-2 focus:ring-blue-400/40"
            ...
            <button
              type="button"
              className="absolute right-9 text-neutral-400 hover:text-blue-400 px-1 py-1"
            ...
            {values.config?.mcp_servers &&
              ...
              <div className="space-y-2">
                    ...
                    >
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            {mcpConfig.tools.map((toolId) => (
                              <Badge
                                key={toolId}
                                variant="outline"
                                className="text-xs bg-[#333] text-blue-400 border-blue-400/30"
                              >
                                {toolId}
                              </Badge>
                            ))}
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          className="flex items-center text-neutral-300 hover:text-blue-400 hover:bg-[#333]"
                        >
                ...
                <Button
                  ...
                  className="w-full mt-2 border-blue-400 text-blue-400 hover:bg-blue-400/10 bg-[#222] hover:text-blue-400"
                >
              ...
              <div className="flex items-center justify-between p-2 bg-[#2a2a2a] rounded-md mb-2">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => onOpenMCPDialog(null)}
                  className="border-blue-400 text-blue-400 hover:bg-blue-400/10 bg-[#222] hover:text-blue-400"
                >
