      ...
      >
        {selectedFiles.length < 5 && (
          <button
            ...
            type="button"
            className="flex items-center justify-center w-9 h-9 rounded-full hover:bg-neutral-800/60 text-neutral-400 hover:text-blue-400 transition-all border border-neutral-700/30"
            title="Attach file"
          >
        ...
        <Textarea
          ...
          className={`flex-1 bg-neutral-800/40 border-neutral-700/50 text-white focus-visible:ring-blue-500/50 focus-visible:border-blue-500/50 min-h-[40px] max-h-[240px] resize-none rounded-xl ${className}`}
          disabled={isLoading}
          rows={1}
          ref={textareaRef}
        />
        <Button
          ...
          className={`bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 rounded-full shadow-md h-9 w-9 p-0 ${buttonClassName}`}
        >
          {isLoading ? (
