...
export function ChatMessage({
  ...
  const getAvatar = () => {
    if (isUser) {
      return (
        <Avatar className="bg-gradient-to-br from-blue-500 to-blue-700 shadow-md border-0">
      ...
      return (
        <Avatar className={`shadow-md border-0 ${isFunctionMessage
  ...
  return (
    ...
    >
      ...
      >
        {getAvatar()}
        <div
          className={`rounded-lg p-3 overflow-hidden relative group shadow-md ${isFunctionMessage || isTaskExecutor
              ? "bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700/50 text-blue-300 font-mono text-sm"
              : isUser
                ...
                {typeof messageContent === "object" &&
                  "title" in messageContent && (
                    <>
                      ...
                      <div className="flex items-center justify-center w-5 h-5 text-blue-400">
                        {isExpanded ? (
              ...
              {((typeof messageContent === "string" &&
                ...
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    a: ({ ...props }) => (
                      <a
                        className="text-blue-300 underline hover:opacity-80 transition-opacity"
                        target="_blank"
                    ...
                    code: ({ className, children, ...props }: any) => {
                      ...
                      if (isInline) {
                        return (
                          <code
                            className="bg-[#333] px-1.5 py-0.5 rounded text-blue-300 text-sm font-mono"
                            {...props}
                          >
                            {children}
                          </code>
