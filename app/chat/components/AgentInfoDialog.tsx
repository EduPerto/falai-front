        ...
        <DialogContent className="sm:max-w-[600px] max-h-[85vh] flex flex-col overflow-hidden bg-neutral-900 border-neutral-700">
          <DialogHeader className="flex flex-row items-start justify-between pb-2">
            ...
            <div className="flex items-center gap-2">
              <Badge
                variant="outline"
                className="bg-neutral-800 border-neutral-700 text-blue-400"
              >
              ...
              <Button
                variant="outline"
                size="icon"
                className="h-8 w-8 rounded-full bg-neutral-800 border-neutral-700 hover:bg-blue-900 hover:text-blue-400"
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-neutral-800 p-3 rounded-md border border-neutral-700 flex flex-col items-center justify-center text-center">
                      <Code className="h-5 w-5 text-blue-400 mb-1" />
                    ...
                    <div className="bg-neutral-800 p-3 rounded-md border border-neutral-700 flex flex-col items-center justify-center text-center">
                      <TagIcon className="h-5 w-5 text-blue-400 mb-1" />
                          ...
                          {agent.config.agent_tools.map((agentId, index) => (
                            ...
                            >
                              <div className="flex items-center">
                                <Bot className="h-3.5 w-3.5 mr-2 text-blue-400" />
                          ...
                          <div className="space-y-2">
                            {agent.config.custom_tools.http_tools.map(
                              (tool, index) => (
                                ...
                                >
                                  <div className="flex items-center">
                                    <Server className="h-3.5 w-3.5 mr-2 text-blue-400" />
                                    <span className="text-sm text-neutral-300">
                                      {tool.name}
                                    </span>
                                  </div>
                                  <Badge
                                    variant="outline"
                                    className="text-xs bg-neutral-800 border-neutral-700 text-blue-400"
                                  >
                                    {tool.method}
                                  </Badge>
                                </div>
