...
Args: ${Object.keys(args).length > 0
  ...
  const handleDeleteSession = async () => {
    ...
    try {
      ...
      toast({
        title: t('chat.session_deleted'),
      });
    } catch (error) {
      console.error("Error deleting session:", error);
      toast({
        title: t('chat.error_deleting_session'),
        variant: "destructive",
      });
    }
  };
  ...
  const handleAgentUpdated = (updatedAgent: any) => {
    ...
    toast({
      title: t('chat.agent_updated'),
      description: t('chat.agent_updated_desc'),
    });
  };
                ...
                return (
                  <div className="flex justify-between items-center">
                    <h2 className="text-xl font-bold text-white flex items-center gap-2">
                      ...
                      {selectedSession
                        ? t('chat.session', { id: sessionInfo?.externalId || selectedSession })
            ...
            >
              {isLoading ? (
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <p className="text-neutral-400 mb-2">{t('chat.loading_conversation')}</p>
                </div>
              ) : messages.length === 0 ? (
                <div className="flex flex-col h-full items-center justify-center text-center p-6">
                  ...
                  <h3 className="text-lg font-medium text-neutral-300 mb-2">
                    {currentAgent ? t('chat.chat_with', { name: currentAgent.name }) : t('chat.new_conversation')}
                  </h3>
        ...
        <DialogContent className="bg-neutral-900 border-neutral-800 text-white shadow-xl">
          ...
          <div className="mt-4 space-y-4">
            <div className="relative">
              ...
              <Input
                placeholder={t('chat.search_agents')}
            ...
            <div className="text-sm text-neutral-300 mb-2">{t('chat.choose_agent')}</div>
            ...
            <ScrollArea className="h-[300px] pr-2">
              {isLoading ? (
                <div className="flex flex-col items-center justify-center py-8">
                  ...
                  <p className="text-neutral-400 mt-4">{t('chat.loading_agents')}</p>
                </div>
                ...
                <div className="text-center py-4 text-neutral-400">
                  {t('chat.no_agent_found', { searchTerm: agentSearchTerm })}
                </div>
              ) : (
                <div className="text-center py-4 text-neutral-400">
                  <p>{t('chat.no_agents_available')}</p>
                  <p className="text-sm mt-2">
                    {t('chat.create_agents_hint')}
                  </p>
                </div>
              )}
            </ScrollArea>
